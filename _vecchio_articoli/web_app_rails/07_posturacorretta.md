...
validate :email_unica_se_non_invitato
  ...
  treepages eliminare external post e mettere solo hash_content


rails g Record user:references tutor:references professional:references pathprofessional:references request_public:datetime approved_tutor_id:references 
